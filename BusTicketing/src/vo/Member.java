...
public class Member {
	...
	public Member(String mem_id, String mem_pass, String mem_name, String mem_regno1, String mem_regno2, String mem_bir,
			String mem_zip, String mem_add1, String mem_add2, String mem_hometel, String mem_comtel, String mem_hp,
			String mem_mail, String mem_job, String mem_like, String mem_memorial, String mem_memorialday,
			String mem_mileage, String mem_delete) {
		super();
		this.mem_id = mem_id;
		this.mem_pass = mem_pass;
		this.mem_name = mem_name;
